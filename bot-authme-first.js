...
const config = {
  server: {
    host: 'RealFriendzzSMP.aternos.me', // Change to your server IP
    port: 13438,
    version: '1.20.4' // Change to your server version
  },
  bot: {
    username: 'BetterThanubot', // Change to your desired bot name
    auth: 'offline', // 'offline', 'microsoft', or 'mojang'
    password: 'boot99', // Minecraft account password (if using premium auth)
